...
export default function NewPluginPage() {
  ...
  const inputClasses =
    "w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-colors";
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-100">Add New Plugin</h1>
      </div>
